-- Migration: ensure record_scan_atomic inserts qr_token into scan_events
...
-- Optional: small test query to validate behaviour (run manually in SQL editor)
-- SELECT record_scan_atomic('put-sample-token-here', 'event-uuid-here'::uuid, 'user-uuid-here'::uuid);
